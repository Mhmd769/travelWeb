...
namespace user_adminlogin.Migrations
{
    ...
    [Migration("20240105182957_add user_package")]
    partial class adduser_package
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("user_adminlogin.Models.Booking", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("user_adminlogin.Models.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("feedback_details")
                        .IsRequired()
                        .HasMaxLength(250)
            ...
            modelBuilder.Entity("user_adminlogin.Models.Flight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("user_adminlogin.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("user_adminlogin.Models.Booking", b =>
                {
                    b.HasOne("user_adminlogin.Models.Flight", "Flight")
